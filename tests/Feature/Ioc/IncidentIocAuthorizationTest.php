...
class IncidentIocAuthorizationTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_ioc_permissions_are_seeded(): void
    {
        $this->seed();
    ...
    public function test_security_manager_has_ioc_permissions(): void
    {
        $this->seed();
    ...
    public function test_soc_analyst_has_ioc_permissions(): void
    {
        $this->seed();
    ...
    public function test_reporter_employee_does_not_have_ioc_permissions(): void
    {
        $this->seed();
