...
class InvestigationNoteAuthorizationTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_investigation_note_permissions_are_seeded(): void
    {
        $this->seed();
    ...
    public function test_security_manager_has_investigation_note_permissions(): void
    {
        $this->seed();
    ...
    public function test_soc_analyst_has_investigation_note_permissions(): void
    {
        $this->seed();
    ...
    public function test_reporter_employee_does_not_have_investigation_note_permissions(): void
    {
        $this->seed();
